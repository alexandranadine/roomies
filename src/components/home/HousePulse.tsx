      ...
      <div className="overflow-hidden rounded-[var(--radius-card)] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-soft)]">
        <div className="flex items-center gap-2 px-3 py-2">
          <div className="flex min-w-0 items-center gap-1.5">
            ...
            />
            <h2 className="truncate text-[13px] font-semibold text-[var(--color-espresso)]">
              House Pulse
            </h2>
          </div>
          <div className="ml-auto flex min-w-0 flex-wrap items-center justify-end gap-x-2 gap-y-0.5 text-[11px] font-medium text-[var(--color-ink-muted)]">
            {data.stats.map((stat) => {
        ...
        <button
          type="button"
          className="flex w-full items-center gap-2 border-t border-[var(--color-border-soft)] bg-[var(--color-cream)] px-3 py-1.5 text-left transition-colors hover:bg-[var(--color-cream-deep)]"
        >
          <CalendarIcon
            size={13}
